...
namespace hmpc::iter
{
    ...
    constexpr decltype(auto) unpack(hmpc::range<Index, Difference, 0, Count, 1>, F const& f) HMPC_NOEXCEPT
    {
    ...
    constexpr decltype(auto) unpack(hmpc::range<Index, Difference, Start, End, 1>, F const& f) HMPC_NOEXCEPT
    {
        using index_type = Index;
