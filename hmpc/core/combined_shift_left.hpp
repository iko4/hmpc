...
namespace hmpc::core
{
    ...
    constexpr auto combined_shift_left(Lower lower, Upper upper, hmpc::size_constant<Shift> shift) HMPC_NOEXCEPT
    {
    ...
    template<typename Lower, typename Upper>
        requires (hmpc::same_without_constant<Lower, Upper>)
    consteval auto combined_shift_left(Lower lower, Upper upper, hmpc::size shift)
    {
        using limb_type = hmpc::traits::remove_constant_t<Lower>;
        using limb_traits = hmpc::core::limb_traits<limb_type>;
