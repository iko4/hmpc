...
TEST_CASE("Integers modulo")
{
    ...
    SECTION("Format")
    {
        REQUIRE(std::format("{}", zero) == "0x0000000000000000000000000000000000000000");
        REQUIRE(std::format("{}", one) == "0x0000000000000000000000000000000000000001");
        REQUIRE(std::format("{}", fivetwelve) == "0x0000000000000000000000000000000000000200");
    }
}
